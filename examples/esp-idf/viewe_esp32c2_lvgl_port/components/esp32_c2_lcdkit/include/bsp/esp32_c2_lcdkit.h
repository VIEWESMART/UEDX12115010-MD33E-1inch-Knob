...
#define BSP_LCD_BL_096          (GPIO_NUM_8)
#define BSP_LCD_BL_100          (GPIO_NUM_8)

#define BSP_LCD_CS_096          (GPIO_NUM_2)
#define BSP_LCD_CS_100          (GPIO_NUM_7)//本来是5和旋钮冲突了

#define BSP_LCD_SELECT          (-1)//切换屏幕的按钮IO
