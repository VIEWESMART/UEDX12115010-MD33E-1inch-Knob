...
//  {cmd, { data }, data_size, delay_ms}
    ...
    {0xC5, (uint8_t []){0x01}, 1, 0},

    {0xE0, (uint8_t []){0x0F,0x11,0x02,0x01,0x0A,0x01,0x00,0x01,0x06,0x0E,0x1B,0x38,0x0A,0x0C,0x03,0x1F}, 16, 0},
    {0xE1, (uint8_t []){0x10,0x09,0x04,0x03,0x0B,0x02,0x00,0x02,0x03,0x07,0x10,0x33,0x0B,0x0E,0x07,0x1E}, 16, 0},
    ...
    {0x2A, (uint8_t []){0x00,0x18,0x00,0x67}, 4, 0},
    {0x2B, (uint8_t []){0x00,0x00,0x00,0x9f}, 4, 0},
...
static esp_err_t panel_ili9341_init(esp_lcd_panel_t *panel)
{
    ...
    ESP_LOGD(TAG, "0.9 send init commands success");
